...
PLUGIN_NAME := kong-plugin-soap4kong
...
define coverage
	...
	@luacov-console /kong-plugin/lua_modules/share/lua/5.1/kong/plugins/soap4kong; \
	luacov-console -s
endef
...
lint:
	@cd kong/plugins/soap4kong && luacheck -q .
...
test: install-dev
	$(call set_env) \
	$(BUSTED_path) $(BUSTED_args) $(current_dir)spec/soap4kong

test-unit: install-dev
	$(call set_env) \
	$(BUSTED_path) $(BUSTED_args) $(current_dir)spec/soap4kong/01-unit

test-integration: install-dev
	$(call set_env) \
	$(BUSTED_path) $(BUSTED_args) $(current_dir)spec/soap4kong/02-integration
